...
public class JeuBataille {
    ...
    public Joueur jouer1Tour() throws ExceptionDeTasVide {
        ...
        if (c1.getHauteur() != c2.getHauteur()) {
            if (c1.getHauteur().compareTo(c2.getHauteur()) < 0)
                j = joueur2;
            ...
            if (c11.getHauteur() != c21.getHauteur()) {
                if (c11.getHauteur().compareTo(c21.getHauteur()) < 0)
                    j = joueur2;
                j.mettreSousLePaquet(c1);
                j.mettreSousLePaquet(c2);
    ...
    public void jouer() throws ExceptionDeTasVide {
        // mélanger le jeu
